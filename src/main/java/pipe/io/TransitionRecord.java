 ...
 * StateSpaceGenerator to save particular transition numbers. This class is used
 * for storing a transition from one GSPN state to another in a file. The file
 * would typically be used to describe a reachability graph.
 */
...
// our code for graduated project
    public TransitionRecord ReadandGetTransistion(RandomAccessFile inputfile) throws IOException {
        read1(inputfile);
        return this;
    }
